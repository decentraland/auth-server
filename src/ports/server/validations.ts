...
import { HttpOutcomeMessage, OutcomeMessage, RecoverMessage, RequestMessage, RequestValidationMessage, IdentityIdRequest } from './types'
...
const identityIdRequestValidator = ajv.compile(identityIdRequestSchema)
